...
export const HOME_DISCOVERY_GROUPS: HomeDiscoveryGroup[] = [
  {
    ...
    filters: [
      ...
      },
      {
        ...
        params: { city: 'Калининград' },
      },
      {
        id: 'baikal',
        labelRu: 'Байкал',
        labelEn: 'Lake Baikal',
        icon: 'ph:drop-half-bottom-duotone',
      ...
      },
      {
        ...
        tone: 'from-indigo-400 to-blue-700',
      ...
      {
        id: 'nn',
        labelRu: 'Нижний Новгород',
        labelEn: 'Nizhny Novgorod',
        icon: 'ph:bridge-duotone',
        tone: 'from-red-400 to-red-700',
        params: { city: 'Нижний Новгород' },
      },
      {
        id: 'murmansk',
        labelRu: 'Мурманск',
