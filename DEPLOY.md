...
| `NUXT_PUBLIC_SUPPORT_EMAIL`, `NUXT_SUPPORT_EMAIL` | `golewood@internet.ru` — UI, legal, contact form (same mailbox as SMTP) |
...
NUXT_PUBLIC_SUPPORT_EMAIL=golewood@internet.ru
