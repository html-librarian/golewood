...
<template>
  ...
  >
    <component
      ...
      class="inline-flex max-w-full items-center gap-1 rounded-full bg-emerald-800 px-2 py-0.5 text-[11px] font-semibold leading-tight text-white ring-1 ring-emerald-700/60 transition hover:bg-emerald-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:bg-emerald-900 dark:text-white dark:ring-emerald-700/50 dark:hover:bg-emerald-800 dark:focus-visible:ring-emerald-400 dark:focus-visible:ring-offset-stone-900"
